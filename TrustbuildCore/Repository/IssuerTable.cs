...
{
    public class IssuerTable : DBTable
    {
        public IssuerTable(SQLiteConnection connection, string tableName = "Issuer")
        {
        ...
        public void CreateIfNotExist()
        {
            ...
            command = new SQLiteCommand("CREATE INDEX IF NOT EXISTS TrustRowId ON " + TableName + " (trustrowid)", Connection);
            command.ExecuteNonQuery();
            command = new SQLiteCommand("CREATE INDEX IF NOT EXISTS TrustIssuerId ON " + TableName + " (id)", Connection);
            command.ExecuteNonQuery();
        }
